...
class Product:
    ...
    def update_stock(self, quantity):
        try:
            if not isinstance(quantity, (int,float)):
                raise ValueError('Provide the valid data')
    ...
    def __repr__(self):
        return f"Product(id={self.product_id}, name='{self.name}', price={self.price}, quantity={self.quantity}, category='{self.category}')"
